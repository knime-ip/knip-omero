...
import org.knime.knip.omero50.insight.HeadlessImageLoader;
 ...
 *         Zinsmaier</a>
 */
public class OmeroReader50NodeModel extends NodeModel implements
		BufferedDataTableHolder {

	private static final NodeLogger LOGGER = NodeLogger
			.getLogger(OmeroReader50NodeModel.class);
	 ...
	 */
	private final String[] SPEED = OmeroReader50NodeDialog.createSpeedArray();
	...
	static SettingsModelString createSpeedSM() {
		final String[] SPEED = OmeroReader50NodeDialog.createSpeedArray();
	 ...
	 */
	protected OmeroReader50NodeModel() {
		super(0, 1);
	}

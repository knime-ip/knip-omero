 ...
 *         Zinsmaier</a>
 */
public class OmeroReader50NodePlugin extends Plugin {
	// The shared instance.
	private static OmeroReader50NodePlugin plugin;

	/**
	 * The constructor.
	 */
	public OmeroReader50NodePlugin() {
		super();
		plugin = this;
	}
	 ...
	 */
	public static OmeroReader50NodePlugin getDefault() {
		return plugin;
	}

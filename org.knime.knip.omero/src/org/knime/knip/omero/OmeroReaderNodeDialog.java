...
import org.knime.knip.omero.insight.InsightGuiListener;
 ...
 *         Zinsmaier</a>
 */
public class OmeroReaderNodeDialog extends NodeDialogPane implements
		InsightGuiListener {

	private static final NodeLogger LOGGER = NodeLogger
			.getLogger(OmeroReaderNodeDialog.class);
	...
	protected void saveSettingsTo(final NodeSettingsWO settings)
		...
		settings.addString(OmeroReaderNodeModel.IMAGE_ID_KEY, listValue);
...
//	@SuppressWarnings("static-access")
		...
		m_startInsightB.addActionListener(e -> {
				if (m_insightGui == null) {
					...
					m_insightGui = new InsightGuiBridge(
							OmeroReaderNodeDialog.this, getUserCredentials());
	...
	private JPanel initCredentialsPanel() {
		// SETTINGS
		final SettingsModelString serverSM = OmeroReaderNodeModel
				.createServerSM();
		final SettingsModelInteger portSM = OmeroReaderNodeModel.createPortSM();
		final SettingsModelString speedSM = OmeroReaderNodeModel
				.createSpeedSM();

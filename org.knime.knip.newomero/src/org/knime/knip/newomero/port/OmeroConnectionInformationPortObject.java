...
public class OmeroConnectionInformationPortObject extends ConnectionInformationPortObject {
	...
	public static final PortType TYPE = PortTypeRegistry.getInstance()
			.getPortType(ConnectionInformationPortObject.class);
	...
	public static final PortType TYPE_OPTIONAL = PortTypeRegistry.getInstance()
			.getPortType(ConnectionInformationPortObject.class, true);
	 ...
	 */
	public OmeroConnectionInformationPortObject(final OmeroConnectionInformationPortObjectSpec omeroConnectionPOS) {
		if (omeroConnectionPOS == null) {
			throw new NullPointerException("Argument must not be null");
		}
		final OmeroConnectionInformation connInfo = omeroConnectionPOS.getOmeroConnectionInformation();
		if (connInfo == null) {

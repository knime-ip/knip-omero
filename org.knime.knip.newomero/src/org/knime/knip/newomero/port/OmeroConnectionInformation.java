...
public class OmeroConnectionInformation extends ConnectionInformation {
	...
	public static OmeroConnectionInformation load(final ModelContentRO model) throws InvalidSettingsException {
		...
		info.setPassword(model.getString("password"));
	...
	@Override
	public void fitsToURI(URI uri) throws Exception {

		final String scheme = uri.getScheme().toLowerCase();
		if (!getProtocol().equals(scheme)) {
			throw new Exception(
					"Protocol " + scheme + " incompatible with connection information protcol " + getProtocol());
		}
		...
		if (!uriHost.toLowerCase().equals(getHost().toLowerCase())) {
			throw new Exception(
					"Host incompatible. URI host: " + uriHost + " connection information host " + getHost());
		}
		// Port
	...
	public boolean equals(Object obj) {
		...
		if (getClass() != obj.getClass())
			return false;
		OmeroConnectionInformation other = (OmeroConnectionInformation) obj;

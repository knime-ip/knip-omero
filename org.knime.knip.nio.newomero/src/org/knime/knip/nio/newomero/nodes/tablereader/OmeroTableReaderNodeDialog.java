...
public class OmeroTableReaderNodeDialog extends DefaultNodeSettingsPane {
	...
	@Override
	public void onOpen() {
		statusText.setText("Click check table ID to check if the table id is valid");
	}
	...
	private void checkValidity() {
		...
		try {
			...
			if (t != null) {
				statusText.setText("Table " + m_tableIdModel.getIntValue() + " located, with " + t.getNumberOfRows()

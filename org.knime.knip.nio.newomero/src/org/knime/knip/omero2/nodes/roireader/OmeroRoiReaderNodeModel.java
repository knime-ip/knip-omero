...
import org.knime.knip.omero2.port.OmeroConnectionInformationPortObject;
import org.knime.knip.omero2.util.OmeroUtils;
...
public class OmeroRoiReaderNodeModel extends NodeModel {
	...
	private final OMEROService m_omeroService = IO2Gateway.getService(OMEROService.class);
	private final OMEROSessionService m_sessions = IO2Gateway.getService(OMEROSessionService.class);
